...
$(".menu-item.product .menu-link").after('<div class="product-child-trigger"></div>'), 
$(".submenu.level-1 .has-submenu > .menu-link").after('<div class="child-trigger"></div>'), 
  ...
  $(this).next("ul").toggle(250).parent().toggleClass("child-open").siblings().removeClass("child-open").find("ul").hide();
}));

$(".menu-item.product").append($(".product-mega-menu"));
$(".product-mega-menu").removeAttr("style");
